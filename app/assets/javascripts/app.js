 ...
 */
define(['angular','angular-resource','angular-route','angular-chosen','angular-blockui', 'home', 'user', 'dashboard'], function(angular) {
  'use strict';

  // We must already declare most dependencies here (except for common), or the submodules' routes
  // will not be resolved
  return angular.module('app', ['ngResource','ngRoute','blockUI','localytics.directives','yourprefix.home', 'yourprefix.user', 'yourprefix.dashboard']);
});
